...
enter_email = driver.find_element_by_css_selector('input[name="emailInput"]')
time.sleep(10)
...
submit_email.click()
enter_password = driver.find_element_by_css_selector('input[class="password"]')
time.sleep(10)
...
for it in range(len(page_count)):
    ...
    print('page {0} is extracted...'.format(it))
